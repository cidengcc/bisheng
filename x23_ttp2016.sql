...
Source Server         : 01-本地数据库
Source Server Version : 50714
Source Host           : localhost:3306
Source Database       : x23_ttp2016

Target Server Type    : MYSQL
Target Server Version : 50714
File Encoding         : 65001

Date: 2017-01-05 10:09:07
*/
...
-- ----------------------------
INSERT INTO `yang_admin` VALUES ('1', 'admin', '21232f297a57a5a743894a0e4a801fc3', '', '1,2,3,4,6,7,8,15,9,10,11,12,13,14,17,16,21,22,26,27,28,29,30,18,33,32,35,36,40,44,41,52,43,45,46,47,48,49,50,51,56,57,58,59,60', '0');
INSERT INTO `yang_admin` VALUES ('6', 'admin123', '0192023a7bbd73250516f069df18b500', 'admin123', '1,2,3,4,6,7,8,15,9,10,11,12,13,14,17,16,21,22,26,27,28,29,30,18,33,32,35,36,40,44,41,52,43,45,46,47,48,49,50,51,56,57,58,59,60', '0');
...
-- ----------------------------
INSERT INTO `yang_config` VALUES ('title', '币胜网数字货币交易平台');
...
INSERT INTO `yang_config` VALUES ('logo', '/Uploads/Public/Uploads/2016-12-27/5861c9e771b91.JPG');
INSERT INTO `yang_config` VALUES ('copyright', 'Copyright 2013-2016 All Rights Reserved. Powered by ttp2016');
...
INSERT INTO `yang_config` VALUES ('jiaoyi_start_hour', '1');
...
CREATE TABLE `yang_currency` (
  ...
  `currency_content` text,
  `currency_all_money` decimal(40,6) DEFAULT NULL COMMENT '总市值',
  ...
  `qianbao_url` varchar(64) DEFAULT NULL COMMENT '钱包储存路径',
  `qianbao_key` varchar(64) NOT NULL COMMENT '钱包密钥',
  `price_up` float(64,4) NOT NULL DEFAULT '0.0000' COMMENT '涨停',
  `price_down` float(64,4) NOT NULL DEFAULT '0.0000' COMMENT '跌停',
...
INSERT INTO `yang_currency` VALUES ('30', '111', '/Uploads/Public/Uploads/2016-11-02/5819d455a02f4.jpg', '111', null, null, '111.0000', '111.0000', '111.0000', '111', '0', '1', '0', '111', '1478087765', '0', '111', '111', '11111', '111', '111', null, '111', '0.0000', '0.0000', '111', '111', null);
...
CREATE TABLE `yang_currency_user` (
  ...
  `status` tinyint(4) NOT NULL,
  `chongzhi_url` varchar(128) DEFAULT NULL COMMENT '钱包充值地址',
  PRIMARY KEY (`cu_id`),
  KEY `member_id_2` (`member_id`,`currency_id`),
  KEY `cu_id` (`cu_id`,`member_id`,`currency_id`,`num`,`forzen_num`,`status`)
) ENGINE=InnoDB AUTO_INCREMENT=863 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
INSERT INTO `yang_currency_user` VALUES ('861', '384', '29', '0.0000', '0.0000', '0', null);
INSERT INTO `yang_currency_user` VALUES ('862', '384', '30', '0.0000', '0.0000', '0', null);
...
INSERT INTO `yang_issue_log` VALUES ('31', '10', '59', '500', '0.100', '1482810859', '0', '27', '250', '26');
...
CREATE TABLE `yang_member` (
  ...
  `vip_level` int(10) DEFAULT NULL COMMENT 'vip等级',
  `vip_end_time` int(10) DEFAULT NULL COMMENT 'vip到期时间',
  `rmb` decimal(20,4) DEFAULT NULL COMMENT '人民币',
  `forzen_rmb` decimal(20,4) DEFAULT NULL COMMENT 'forzen_rmb',
  `head` varchar(64) DEFAULT NULL COMMENT 'head',
  `profile` text COMMENT '个人简介',
  `province` int(10) DEFAULT NULL COMMENT '省市',
  `city` int(10) DEFAULT NULL COMMENT '城市',
  `job` varchar(64) DEFAULT NULL COMMENT '职位/头衔',
  `is_lock` tinyint(2) NOT NULL DEFAULT '0' COMMENT '0是正常 1是锁定',
  `status` tinyint(4) DEFAULT NULL COMMENT '0=有效未填写个人信息1=有效并且填写完个人信息2=无效',
...
-- ----------------------------
INSERT INTO `yang_member` VALUES ('78', '', '353763004@qq.com', 'e10adc3949ba59abbe56e057f20f883e', '', '1aaeabb7187be5c1d21cfff575c8fb86', 'xin888', '邱佳欣', '1', '421222199404280045', '13986617911', '121.61.56.121', '1462373515', '222.240.194.108', '1462997299', '0', '0', '0.0000', '0.0000', '', '', '0', '0', '', '0', '1', '0.0000', '');
...
INSERT INTO `yang_member` VALUES ('384', null, '123456789@qq.com', 'e10adc3949ba59abbe56e057f20f883e', '', '96e79218965eb72c92a549dd5a330112', '', null, '1', null, null, '192.168.0.80', '1482810858', null, null, null, null, null, null, null, null, null, null, null, '0', null, '0.0000', '');
...
CREATE TABLE `yang_orders` (
  ...
  `add_time` int(10) NOT NULL,
  `trade_time` int(10) NOT NULL DEFAULT '0' COMMENT '成交时间',
